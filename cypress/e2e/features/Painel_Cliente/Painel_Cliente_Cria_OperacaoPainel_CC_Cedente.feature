Feature: Painel do cliente cria operação Cartão de Crédito no painel Cedente
  ...
  Scenario: Painel do cliente cria operação Cartão de Crédito no painel Cedente
