Feature: Painel do cliente cria operação Duplicata de Serviço no painel Cedente
  ...
  Scenario: Painel do cliente cria operação Duplicata de Serviço no painel Cedente
