Feature: Painel do cliente cria operação Conhecimento de Transporte no painel Cedente
  ...
  Scenario: Painel do cliente cria operação Conhecimento de Transporte no painel Cedente
