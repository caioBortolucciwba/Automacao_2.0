Feature: Painel do cliente cria operação Conhecimento de Transporte OS no painel Cedente
  ...
  Scenario: Painel do cliente cria operação Conhecimento de Transporte OS no painel Cedente
