Feature: Painel do cliente cria operação Cédula de Crédito Bancário no painel Cedente
  ...
  Scenario: Painel do cliente cria operação Cédula de Crédito Bancário no painel Cedente
