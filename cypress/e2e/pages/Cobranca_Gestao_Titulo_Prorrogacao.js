class Prorrogacao {
    ...
    validarCamposProrrogacao() {
      ...
      cy.get(':nth-child(4) > #input-multa > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix').type('500');
      cy.get(':nth-child(4) > #input-multa > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix').type('1000');
