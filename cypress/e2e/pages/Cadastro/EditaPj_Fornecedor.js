...
class EditaPjFornecedor {
    ...
    preencherEditaPjFornecedor(){
        cy.get('#input-search').type('FORNECEDOR');
        cy.get("#bt-search").click(); 
        ...
        cy.get('#mat-input-14').type('Teste EDITA PJ FORNECEDOR');
  ...
  export default EditaPjFornecedor;
