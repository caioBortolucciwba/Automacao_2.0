...
class ExcluiPfInstFinanceira{
    ExcluiPfInstFinanceira(){
        cy.get('#menu-lateral-CADASTRO > .flex-column > .menu-click-js').click();
        cy.get('#item-menu-1 > span').click();
        cy.get("#bt-search").click();
    }

    preencherExcluiPfInstFinanceira(){
        cy.get('#input-search').type('Pablito Aimar');
        cy.get("#bt-search").click(); 
  ...
  export default ExcluiPfInstFinanceira;
