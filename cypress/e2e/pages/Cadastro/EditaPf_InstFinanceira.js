...
class EditaPfInstFinanceira {
    EditaPfInstFinanceira(){
        cy.get('#menu-lateral-CADASTRO > .flex-column > .menu-click-js').click();
        cy.get('#item-menu-1').click();
        cy.get("#bt-search").click();
    }

    preencherEditaPfInstFinanceira(){
    cy.fixture('cpf/cpf_instfinanceira').then((data) => {
            ...
            cy.get('#mat-input-14').type('Teste EDITA Pf InstFinanceira');
  ...
  export default EditaPfInstFinanceira;
