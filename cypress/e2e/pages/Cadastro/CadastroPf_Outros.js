...
class CadastroPFOutros {
    ...
    preencherCadastroPfOutros(){
        ...
        cy.get('#mat-input-21').type('Americano');
        cy.get('#mat-input-22').type('California');
        cy.get('#mat-input-23').type('Francisca');
        cy.get('#mat-input-24').type('Pedro Paulo');
        cy.get('#mat-input-25').type('Aviador');
        ...
        cy.get('#mat-input-33').type('outrosoutros.com.br')
        cy.get('#mat-input-27').type('11');
        cy.get('#mat-input-28').type('978536199');
        cy.get('#mat-input-29').type('testeoutros@wba.com.br')
        ...
        cy.contains('DE 1 A 2 SALÁRIOS MÍNIMOS').click();               
        ...
        /////////////PARAMETROS POR EMPRESA//////////////////// ESTÁ COM BUG JÁ INFORMADO PARA TODOS OS CADASTROS
  ...
  export default CadastroPFOutros;
