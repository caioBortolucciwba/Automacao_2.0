...
class EditaPfEmpresa {
    ...
    preencherEditaPfEmpresa(){
        cy.get('#input-search').type('661.858.298-94');
        cy.get("#bt-search").click(); 
        ...
        cy.get('#mat-input-14').type('Teste EDITA Pf EMPRESA');
