...
class PainelCliente {
    painelClienteCriaOperacaoCedenteDs() {
      cy.wait(300);
    ...
    painelClienteCriaOperacaoPainlCedenteDs(){
      cy.get('.mega-menu > :nth-child(1) > #item-0').click();
      cy.get('.w-select-input > .mat-icon').click();
      cy.contains('Duplicata Serviço').click();
      cy.get('#mat-input-19').type('2222222222');
      cy.get('#mat-input-20').type('2222222222');
      ...
      cy.get('#btn-label-incluir > .ng-star-inserted').click();
