...
class PainelCliente {
    painelClienteCriaOperacaoCedenteNp() {
      cy.wait(300);
    ...
    painelClienteCriaOperacaoPainlCedenteNp(){
      cy.get('.mega-menu > :nth-child(1) > #item-0').click();
      cy.get('.w-select-input > .mat-icon').click();
      cy.contains('Nota promissoria').click();
      cy.get('#mat-input-19').type('9999999999');
      cy.get('#mat-input-20').type('9999999999');
