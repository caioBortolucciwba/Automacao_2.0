...
class PainelCliente {
    painelClienteCriaOperacaoCedenteCt() {
      cy.wait(300);
    ...
    painelClienteCriaOperacaoPainlCedenteCt(){
      cy.get('.mega-menu > :nth-child(1) > #item-0').click();
      cy.get('.w-select-input > .mat-icon').click();
      cy.contains('Conhecimento de Transporte').click();
      cy.get('#mat-input-19').type('4444444444');
      cy.get('#mat-input-20').type('4444444444');
