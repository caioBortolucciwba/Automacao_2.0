...
class PainelCliente {
    painelClienteRenanFidicSacadoDesabilitado() {
        const cpf = gerarCPF();
        ...
        cy.get("#mat-input-2").type('Teste RENAN FIDIC SACADO DESABILITADO');
        ...
        cy.get('#mat-input-34').click().type('Teste RENAN SACADO DESABILITADO');
