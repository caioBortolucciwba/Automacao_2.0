...
class PainelCliente {
    painelClienteCriaOperacaoCedenteCh() {
      cy.wait(300);
    ...
    painelClienteCriaOperacaoPainlCedenteCh(){
      ...
      cy.get('#mat-input-21').type('237455560015653355700533434353');
      cy.wait(3000);
