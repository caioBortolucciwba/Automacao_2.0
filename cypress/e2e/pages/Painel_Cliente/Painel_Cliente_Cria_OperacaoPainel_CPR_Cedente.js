...
class PainelCliente {
    painelClienteCriaOperacaoCedenteCpr() {
      cy.wait(300);
    ...
    painelClienteCriaOperacaoPainlCedenteCpr(){
      cy.get('.mega-menu > :nth-child(1) > #item-0').click();
      cy.get('.w-select-input > .mat-icon').click();
      cy.contains('Cedula de produto rural').click();
      cy.get('#mat-input-19').type('8888888888');
      cy.get('#mat-input-20').type('8888888888');
