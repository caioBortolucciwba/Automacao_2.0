...
class PainelCliente {
    painelClienteCriaOperacaoCedenteCf() {
      cy.wait(300);
    ...
    painelClienteCriaOperacaoPainlCedenteCf(){
      cy.get('.mega-menu > :nth-child(1) > #item-0').click();
      cy.get('.w-select-input > .mat-icon').click();
      cy.contains('Contrato futuro').click();
      cy.get('#mat-input-19').type('7777777777');
      cy.get('#mat-input-20').type('7777777777');
