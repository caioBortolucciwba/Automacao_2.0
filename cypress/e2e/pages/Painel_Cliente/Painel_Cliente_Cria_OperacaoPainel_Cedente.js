...
class PainelCliente {
    painelClienteCriaOperacaoCedente() {
      cy.wait(300);
    ...
    painelClienteCriaOperacaoPainlCedente(){
      cy.get('.mega-menu > :nth-child(1) > #item-0').click();
      cy.get('.w-select-input > .mat-icon').click();
      cy.contains('Duplicata Mercantil').click();
      cy.get('#mat-input-19').type('1111111111');
      cy.get('#mat-input-20').type('1111111111');
