...
class operacionalNC{
    ...
    digitandotituloNcManualmente() {
        ...
        //Step 1 - Digita título DM preenchendo campos obrigatórios e criando um sacado novo
                ...
                cy.get('#select-tipo-recebivel > .w-select > .overlay > .w-select-list > .search-option')
                    .should('be.visible').type("Nota comercial");
        
                cy.get('#select-tipo-recebivel > .w-select > .overlay > .w-select-list > [ng-reflect-label="Nota Comercial"]')
                    .should('be.visible')
                    .click();
    ...
    concluindoOperacaoNotaComercial() {
    ...
    cy.log('✅ Borderô de Nota comercial Finalizado com Sucesso.');
