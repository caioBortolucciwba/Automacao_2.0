...
class operacionalNC{
    ...
    criandoNC() {
        ...
        cy.get('#select-tipo-recebivel > .w-select > .overlay > .w-select-list > [ng-reflect-label="Nota Promissoria"] > .label-option').click();
        cy.get('#input-n-documento > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix').type('NC1503');
