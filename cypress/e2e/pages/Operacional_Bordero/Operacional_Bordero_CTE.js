...
class OperacionalBorderoCTE {
    ...
    criandoOpImportandoCTE() {
        const numeroDocumentoGerado = gerarNumeroAleatorio(5);
                    ...
                    cy.get('.uploadfilecontainer')
                        .should('be.visible').click();
                    cy.get('input[type="file"]').attachFile('CTE.xml');
    ...
    cy.log('✅ Borderô de importação de CTE Finalizado com Sucesso.');

    }
   
}
    
export default OperacionalBorderoCTE;